...
export const BASIC_AUTH_USER =
  process.env.BASIC_AUTH_USER ||
  (fileSettings.basicAuthEnabled ? fileSettings.basicAuthUser : undefined);
export const BASIC_AUTH_PASSWORD =
  process.env.BASIC_AUTH_PASSWORD ||
  (fileSettings.basicAuthEnabled ? fileSettings.basicAuthPassword : undefined);
...
export const dataDir =
  fsSync.existsSync(path.dirname(packagedDataDir)) && !fsSync.existsSync(devDataDir)
    ? packagedDataDir
    : devDataDir;
