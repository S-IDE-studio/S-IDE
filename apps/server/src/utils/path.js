...
export function getWorkspaceName(workspacePath, index) {
 ...
 */
export async function resolveSafePath(workspacePath, inputPath = "") {
 ...
 */
export function validatePathSyntax(inputPath) {
