        ...
        <div className="modal-body">
            ...
            <div className="form-group">
              ...
              <div className="form-row">
                <input
                  ...
                  value={actionPort}
                  onChange={(e) => setActionPort(e.target.value)}
                  min={1024}
                  max={65535}
                />
                <button
                  ...
                  disabled={isPerformingAction || status === "running"}
                >
                ...
                <button
                  ...
                  disabled={isPerformingAction || status === "stopped"}
                >
                  Stop
                </button>
              </div>
          ...
          <div className="settings-section">
            ...
            <div className="server-logs">
              {logs.length === 0 ? (
                <div className="server-logs-empty">No logs yet</div>
              ) : (
                logs.map((log, index) => (
                  <div key={index} className="server-log-entry">
                    {log}
                  </div>
                ))
              )}
