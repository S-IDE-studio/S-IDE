...
/// Find npx command to run localtunnel
fn find_npx_command() -> Result<String, String> {
...
pub fn start(port: u16) -> Result<TunnelHandle, String> {
    ...
    // Spawn background task to capture URL from stdout
